...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/04/14 21:10:06 by alhelson          #+#    #+#             */
/*   Updated: 2018/04/14 21:10:39 by alhelson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void							handle_32(t_nm *nm)
{
	...
	while (nm->nb_elem == 0 || i < nm->nb_elem)
	{
		if (lc->cmd == LC_SYMTAB)
		{
			...
			store_nlist_32(nm, sym->symoff, sym->stroff, sym->strsize);
			break ;
		}
		else if (lc->cmd == LC_SEGMENT)
			store_data_segment_section_32(nm, lc);
